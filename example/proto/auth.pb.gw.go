...
func local_request_Example_Test_0(ctx context.Context, marshaler runtime.Marshaler, server ExampleServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExampleMessage
	var metadata runtime.ServerMetadata
...
func RegisterExampleHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ExampleServer) error {
	...
	mux.Handle("POST", pattern_Example_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Example_Test_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_Example_Test_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"example", "test"}, "", runtime.AssumeColonVerbOpt(true)))
)
